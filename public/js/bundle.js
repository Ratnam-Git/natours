    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          ...
          if (res.data.status = 'success') {
            (0, _alerts.showAlert)('success', 'Logged in Successfully'); // reloading and going back to home page
  ...
  _regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51OgTYpSJ7pyw5rLPMzHdMYaQ6LhDOvwPykhJRs7WrbfvLg1CRHALWqgChhjURL3fyIHrFHMZZzxoiO4EaGs8wHlS00RG2vCuZ4'); // 1) get the session from the server
        ...
        case 4:
          ...
          console.log(session); // 2) Use stripe object to create the checkout form + charge credit card
...
var userImgInputEl = document.querySelector('#photo'); // console.log(logOutBtn);
// delegation
...
if (signupForm) {
  ...
  signupForm.addEventListener('submit', function (e) {
    ...
    var passwordConfirm = document.getElementById('passwordConfirmSignup').value; // console.log(name, email, password, passwordConfirm);
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault(); // recreating a multi-part form data
  ...
  _regeneratorRuntime().mark(function _callee(e) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          form = new FormData();
          form.append('photo', document.getElementById('photo').files[0]); // Take care of the type attribute being photo
...
var handleDisplayUserPhoto = function handleDisplayUserPhoto(e) {
